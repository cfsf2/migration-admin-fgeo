...
import { ADD_TRANSFER, SUBMITTING } from "../../../redux/actions/transfersActions";
...
class FinalizarTransfer extends Component {
    ...
    createHtmlMail = async (transfer, direccioncompleta) => {
        ...
        let body = `<head>
                      ...
                      <body>
                        <div>
                          <p><b>Farmacia: </b>${transfer.farmacia_nombre} / <b>Cuit: </b>${transfer.cuit}</p>
    ...
    async handleSubmit() {
        const {
            ...
            cufe,
            nombre,
            direccioncompleta } = this.props.authReducer.userprofile;
    ...
    render() {
        ...
        const { email, cuit, telefono, cufe, nombre, direccioncompleta } = this.props.authReducer.userprofile;
