...
class Infointeres extends Component {
  constructor(props) {
    super(props);
    this.state = {
      publicidad: null,
          ...
          <Col xs="12" sm="12">
            <Card>
              <CardHeader>
                ...
                >
                  + Agregar información de interés
                </Button>
              </CardHeader>
              <CardBody>
                <Row>
                  <Col>
                    <Card>
                      <CardHeader>
                        <b>Listado de información de interés</b>
                      </CardHeader>
                      <CardBody>
                        {this.props.publicidadesReducer.publicidades.map(
                          (p, index) => {
                            return p.tipo === "infointeres" ? (
                              <Fragment key={index}>
                                <Row>
                                  <Col>
                                    <Row>
                          ...
                          <Row>
                            <Col xs="12" sm="12">
                              <Card>
                                <CardHeader>
                                  <Row>
                                    <Col>Editar información de interés</Col>
                                  </Row>
                                </CardHeader>
                                <CardBody>
                                  <FormGroup>
                          ...
                          <Row>
                            <Col xs="12" sm="12">
                              <Card>
                                <CardHeader>
                                  <Row>
                                    <Col>Agregar información de interés</Col>
                                  </Row>
                                </CardHeader>
                                <CardBody>
                                  <FormGroup>
...
export default connect(mapStateToProps, mapDispatchToProps)(Infointeres);
