...
class Servicios extends Component {
  ...
  async handleInputChange(event) {
    ...
    if(value){
      ...
      await this.setState({ 
        servicios: this.state.servicios.filter(s => { return s.tipo !== name })
      })
    }
  ...
  render() {
    return (
      <div className="animated fadeIn">
                  ...
                  <Col xs="12">
                    <Row>
                      ...
                      <Col className="my-3" xs="6" md="3">
                        <div align="center" >
                          <img src={require('../../assets/images/icons/de_turno.png')} style={{width:50}} />
                      ...
                      <Col className="my-3" xs="6" md="3"> 
                        <div align="center">
                          <img src={require('../../assets/images/icons/injection.png')} style={{width:50}} />
                      ...
                      <Col className="my-3" xs="6" md="3">
                        <div align="center" >
                          <img src={require('../../assets/images/icons/blood-pressure.png')} style={{width:50}} />
                      ...
                      <Col className="my-3" xs="6" md="3">
                        <div align="center" >
                          <img src={require('../../assets/images/icons/punto-amarillo.png')} style={{width:50}} />
                      ...
                      <Col className="my-3" xs="6" md="3">
                        <div align="center" >
                          <img src={require('../../assets/images/icons/004-whatsapp.png')} style={{width:50}} />
                      ...
                      <Col className="my-3" xs="6" md="3">
                        <div align="center" >
                          <img src={require('../../assets/images/icons/farmacia-violeta.png')} style={{width:90, marginTop:10}} />
                      ...
                      <Col className="my-3" xs="6" md="3">
                        <div align="center" >
                          <img src={require('../../assets/images/icons/recetas-magistrales.png')} style={{width:50}} />
        ...
        <Row>
          <Col>
            <Button className="mb-3" style={{float:"right", backgroundColor:'#00D579', color:'white'}} onClick={this.handleEditProfile}>Guardar</Button>
          </Col>
        </Row>
      </div>
    );
