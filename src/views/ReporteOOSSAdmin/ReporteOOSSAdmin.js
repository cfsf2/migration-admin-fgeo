...
const ReporteOOSSAdmin = (props) => {
  ...
  useEffect(() => {
    document.getElementById("nuevaOS").focus();
  }, [inactivas.length, newInactiva]);
        ...
        <Col xs="12" sm="12">
          <Card>
              ...
              <Row>
                <Col xs="12" className="d-flex flex-column" sm="6">
                  ...
                  <span className="small">
                    Archivo actual: {props.reportOSReducer.attachName}
                  </span>
                  <FormLabel className="mt-3">
                    Texto decorativo de aviso
                  </FormLabel>
                  <textarea
                    type="textarea"
                    value={alerta}
                ...
                <Col xs="12" sm="6" className="d-flex flex-column">
                  <FormLabel>Lista OOSS Inactivas</FormLabel>
                  <br />
                  {inactivas
                    ? inactivas.map((os, i) => {
                        return (
                  ...
                  <Input
                    ...
                    placeholder="Nueva"
                    onChange={(e) => {
                      setnewInactiva(e.target.value);
                    }}
                    onBlur={(e) => handleNewInput(e.target.value, e)}
                    type="text"
                  />
                </Col>
              </Row>
            ...
            <CardFooter className="d-flex">
              <Button onClick={saveHandler} className="ml-auto" color="primary">
                Guardar
              </Button>
            </CardFooter>
          </Card>
