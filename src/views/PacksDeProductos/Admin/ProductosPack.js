...
class ProductosPack extends Component {
  constructor(props) {
    ...
    this.handleCalcularPVP = this.handleCalcularPVP.bind(this);
    this.handleAjustarRentabilidad = this.handleAjustarRentabilidad.bind(this);
    this.handleCalculoInversoDesdePVP = this.handleCalculoInversoDesdePVP.bind(
      this
    );
  ...
  async handleListadoPapelera() {
    const { productos } = this.props.packsproductosReducer;
    ...
    console.log(filter);
    filter.map((f) => {
      this.props.DELETE_PRODUCTO_PACK(f);
    });
  }
                              ...
                              <tr key={index}>
                                ...
                                <td>
                                  ...
                                  <Button
                                    className="btn btn-danger"
                                    onClick={() =>
                                      this.props.DELETE_PRODUCTO_PACK(obj)
                                    }
                                  >
                                    Enviar a Papelera
                                  </Button>
